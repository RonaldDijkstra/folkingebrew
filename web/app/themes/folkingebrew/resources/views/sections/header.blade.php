<header class="bg-black md:px-6 h-16 md:h-20 flex items-center justify-between transition-all duration-150 ease-in-out w-full left-0 top-0 z-10 fixed motion-reduce:transition-none has-adminbar:top-[46px] wp:has-adminbar:top-[32px]" id="site-header">
